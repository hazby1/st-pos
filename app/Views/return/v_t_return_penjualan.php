<div class="row">
    ...
    <div class="col-12">
        ...
        <table class="table table-striped table-bordered table-sm">
            ...
            <?php $no = 1;
            foreach ($datareturnpenjualan as $key => $nilai) {
            ...
            <tr class="bg-gray">
                ...
                <td class="" style="border-right: 0;">Rp</td>
                <th class="text-right" style="border-left: 0;"><?= $datareturnpenjualan == null ? '' : number_format(array_sum($grandtotal)); ?></th>
            </tr>
        </table>
    </div>
</div>
...
<?php foreach ($datareturnpenjualan as $key => $nilai) { ?>
    <div class="modal  fade" id="delete-data<?= $nilai['kode_produk'] ?>">
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <!-- Form -->
                <?= form_open('ReturnBarang/ReturnBarangPenjualan'); ?>
                <div class="modal-body">
                    <input hidden id="no_faktur" name="no_faktur" value="<?= $no_faktur; ?>">
                    ...
                    <input hidden id="id_pelanggan" name="id_pelanggan" value="<?= $nilai['id_pelanggan']; ?>">
                    <div class="form-group">
                        <label for="">Harga terjual</label>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <div class="form-control form-control-lg"><?= $nilai['nama_pelanggan']; ?></div>
                        </div>
                    </div>
                    <div class="form-group">
